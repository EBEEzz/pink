 ...
 * 요청내용을 분석하고 실행할 클래스를 선택해서 실행(디스패치)시켜줄 서블릿클래스이다.
 * @author 	안은비
 * @since	2022/05/11
 * @version	v.1.0
 * @see
	...
	public void init(ServletConfig config) throws ServletException {
		/*
		 	할일)
		 		...
		 		준비된 properties 파일을 읽어서 이를 이용해 맵을 만들어 놓는다.
		 		즉, 요청이 오면 사용할 클래스가 무엇인지 먼저 등록해둔다.
		 */
		
		//파일에서 직접 읽어서 Map으로 만들어야하므로 Properties라는 클래스를 이용해서 작업한다.
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*
		 	참고)
		 		...
		 		이때 변수는 실제 실행되는 함수내에서도 알 수 있어야하므로
		 		요청객체에 기억시키기로 한다.
		 */
